(async function () {
    ...
    async function fuben() {
        ...
        await sleep(10);
        await textOCREnhanced((genshin.getText ? genshin.getText("ley_line_disorder") : (genshin.getText ? genshin.getText("ley_line_disorder") : "地脉异常")), 10, 1, 0, 840, 405, 180, 55);// 等待“地脉异常”出现
