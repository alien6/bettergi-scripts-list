...
async function deleteSource() {
  ...
  await findTextAndClick((genshin.getText ? genshin.getText("confirm") : (genshin.getText ? genshin.getText("confirm") : "确认")), 960, 600, 960, 400, 50, 100);
  await findTextAndClick((genshin.getText ? genshin.getText("confirm") : (genshin.getText ? genshin.getText("confirm") : "确认")), 960, 600, 960, 400, 50, 100);
...
async function exitRoom() {
  ...
  await waitUntilTextAppear(
    (genshin.getText ? genshin.getText("confirm") : (genshin.getText ? genshin.getText("confirm") : "确认")),
    async () => {
  ...
  await findTextAndClick((genshin.getText ? genshin.getText("confirm") : (genshin.getText ? genshin.getText("confirm") : "确认")), 960, 600, 960, 400, 50);
  await genshin.returnMainUi();
}
...
async function exitToTeyvat() {
  ...
  await sleep(duration);
  await findTextAndClick((genshin.getText ? genshin.getText("confirm") : (genshin.getText ? genshin.getText("confirm") : "确认")), 960, 600, 960, 400);
