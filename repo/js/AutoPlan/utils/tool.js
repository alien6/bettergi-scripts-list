...
export async function outDomainUI() {
    Log.info(`{0}`, (genshin.getText ? genshin.getText("exit_domain") : (genshin.getText ? genshin.getText("exit_domain") : "退出秘境")));
    const ocrRegion = {
        x: 509,
        y: 259,
        w: 901,
...
export async function outStygianOnslaughtUI() {
    Log.info(`{0}`, (genshin.getText ? genshin.getText("exit_challenge") : (genshin.getText ? genshin.getText("exit_challenge") : "退出挑战")));
    const ocrRegion = {
        x: 509,
        y: 259,
        w: 901,
