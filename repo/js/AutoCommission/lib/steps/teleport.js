...
(function() {
  ...
  // 同时注册(genshin.getText ? genshin.getText("teleport") : (genshin.getText ? genshin.getText("teleport") : "传送"))别名
  StepProcessorLoader.register((genshin.getText ? genshin.getText("teleport") : (genshin.getText ? genshin.getText("teleport") : "传送")), async function(step, context) {
...
或者带强制传送参数:
{
  "type": (genshin.getText ? genshin.getText("teleport") : (genshin.getText ? genshin.getText("teleport") : "传送")),
